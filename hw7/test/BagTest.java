...
public class BagTest {
    ...
    public void addEqument() {
        Bag bag = new Bag();
        bag.addEqument(123,"sword");
        assertTrue(bag.findEqument("sword"));
    }

    @Test
    public void findEqument() {
        Bag bag = new Bag();
        bag.addEqument(123,"sword");
        assertTrue(bag.findEqument("sword"));
    }
    ...
    public void removeFood() {
        ...
        bag.addFood("beef", 456);
        assertTrue(bag.findFood("beef"));
        bag.removeFood("beef",123);
        bag.removeFood("beef",456);
        assertFalse(bag.findFood("beef"));
    }
    ...
    public void getEqu() {
        Bag bag = new Bag();
        bag.addEqument(123,"sword");
        assertEquals(bag.getEqu("sword"),123);
    }

    @Test
    public void removeEqu() {
    }

    @Test
    public void countPrice() {
        Bag bag = new Bag();
        bag.countPrice(null,null,null);
    }
